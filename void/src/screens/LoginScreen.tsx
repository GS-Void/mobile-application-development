        ...
        >
          <Animated.View style={[styles.card, { opacity: formOpacity, transform: [{ translateY: formY }] }]}>
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>Autentique-se com suas credenciais institucionais</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  form: { gap: 16 },
  inputGroup: { gap: 8 },
  label: { fontSize: 13, color: '#7A8FB5', fontWeight: '500', letterSpacing: 0.5 },
  inputWrapper: {
  ...
  backText: { color: '#4F8EF7', fontSize: 14, fontWeight: '500' },
});
